...
namespace Acme.SimpleTaskApp.Migrations
{
    ...
    [Migration("20251211102803_fix comment and ratting")]
    partial class fixcommentandratting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Banners.Banner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Carts.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OrderDetailJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.ProductComments.ProductComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.ProductRatings.ProductRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("AdminResponseTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.ProductRatings.ProductRatingHelpful", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductRatingHelpfuls");
                });

            modelBuilder.Entity("Acme.SimpleTaskApp.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CameraSystem")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Products.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Products.ProductVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppProductVariants");
                });

            modelBuilder.Entity("Acme.SimpleTaskApp.Sales.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Acme.SimpleTaskApp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Acme.SimpleTaskApp.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("Acme.SimpleTaskApp.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Acme.SimpleTaskApp.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
