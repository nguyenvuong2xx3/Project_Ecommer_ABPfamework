...
//using Acme.SimpleTaskApp.Templates;
...
//	{
//		private readonly IProductExportTemplateAppService _productExportService;

//		public TemplateController(IProductExportTemplateAppService productExportService)
//		{
...
//			try
//			{
//				var result = await _productExportService.ExportProductsWithImagesAsync(input ?? new ExportProductInput());
...
//			try
//			{
//				var result = await _productExportService.ExportProductsWithImagesAsync(new ExportProductInput());
...
//			catch (Exception ex)
//			{
//				Logger.Error("Error exporting all products", ex);
//				return Json(new { success = false, message = "Lỗi export tất cả sản phẩm: " + ex.Message });
//			}
//		}
...
//			try
//			{
//				var input = new ExportProductInput { CategoryId = categoryId };
//				var result = await _productExportService.ExportProductsWithImagesAsync(input);
...
//			catch (Exception ex)
//			{
//				Logger.Error($"Error exporting products by category {categoryId}", ex);
//				return Json(new { success = false, message = "Lỗi export sản phẩm theo danh mục: " + ex.Message });
//			}
//		}
...
//		/// </summary>
//		[HttpPost]
//		public async Task<IActionResult> ExportSelectedProducts([FromBody] List<int> productIds)
//		{
//			try
//			{
//				var input = new ExportProductInput { ProductIds = productIds };
//				var result = await _productExportService.ExportProductsWithImagesAsync(input);
...
//			catch (Exception ex)
//			{
//				Logger.Error("Error exporting selected products", ex);
//				return Json(new { success = false, message = "Lỗi export sản phẩm đã chọn: " + ex.Message });
//			}
//		}
