    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: (data, type, row, meta) => {
          return [
            `   <button type="button" class="btn btn-sm bg-secondary edit-productvariant" data-productvariant-id="${row.id}" data-toggle="modal" data-target="#ProductVariantEditModal">`,
            `       <i class="fas fa-pencil-alt"></i> ${l('Edit')}`,
            '   </button>',
            `   <button type="button" class="btn btn-sm bg-danger delete-productvariant" data-productvariant-id="${row.id}" data-productvariant-name="${row.productName}">`,
