(function ($) {
	...
	var _createModal = new app.ModalManager({
		viewUrl: abp.appPath + 'ProductVariant/CreateModal',
		scriptUrl: abp.appPath + 'view-resources/Views/ProductVariant/_CreateModal.js',
	...
	var _editModal = new app.ModalManager({
		viewUrl: abp.appPath + 'ProductVariant/EditModal',
		scriptUrl: abp.appPath + 'view-resources/Views/ProductVariant/_EditModal.js',
