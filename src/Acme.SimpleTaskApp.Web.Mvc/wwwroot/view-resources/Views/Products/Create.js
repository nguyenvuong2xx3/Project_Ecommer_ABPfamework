(function ($) {
                ...
                <tr class="variant-row" data-index="${index}">
                    ...
                    <td>
                        <div class="variant-image-container">
                            <input type="file" name="Variants[${index}].ImageFiles" class="d-none" accept="image/*" multiple>
                    ...
                    <td>
                        <input type="number" name="Variants[${index}].StockQuantity" class="form-control" placeholder="Số lượng" required min="0">
                    </td>
  ...
  _$form.on('submit', function (e) {
    ...
    //    abp.notify.info("Tạo sản phẩm thành công!");
    //    // Chuyển hướng về trang danh sách
    //    window.location.href = '/Products';
    //  },
    //  error: function (err) {
    //    console.error(err);
    //    abp.message.error('Đã có lỗi xảy ra trong quá trình tạo sản phẩm. Vui lòng kiểm tra lại thông tin.', 'Lỗi');
    //  },
    //  complete: function () {
    ...
    $.ajax({
      ...
      url: abp.appPath + 'Products/CreateProduct', // Đường dẫn đến phương thức trong controller
      type: 'POST',
