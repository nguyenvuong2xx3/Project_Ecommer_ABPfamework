(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      ...
      scriptUrl: abp.appPath + 'view-resources/App/Languages/_CreateOrEditModal.js',
      modalClass: 'CreateOrEditLanguageModal',
    });

    var _importModal = new app.ModalManager({
      viewUrl: abp.appPath + 'App/Languages/ImportLanguageModal',
      scriptUrl: abp.appPath + 'view-resources/App/Languages/_ImportLanguageModal.js',
      modalClass: 'ImportLanguageModal',
      modalSize: 'modal-xl'
    });
    ...
    var dataTable = _$languagesTable.DataTable({
      ...
      columnDefs: [
        {
          className: 'dtr-control responsive', visible: false,
          orderable: false,
          render: function () {
            return '';
          },
        ...
        },
        {
          ...
          render: function (tenantId, type, row, meta) {
            ...
            if (meta.settings.rawServerResponse.defaultLanguageName === row.name) {
              $span.addClass('badge bg-success text-white').text(app.localize('Yes'));
            } else {
              $span.addClass('badge bg-dark text-white').text(app.localize('No'));
            }
