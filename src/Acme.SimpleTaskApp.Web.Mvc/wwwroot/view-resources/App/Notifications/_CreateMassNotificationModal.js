(function ($) {
    app.modals.CreateMassNotificationModal = function () {
        ...
        var _userLookupTableModal = new app.ModalManager({
            ...
            scriptUrl: abp.appPath + 'view-resources/App/Notifications/_UserLookupTableModal.js',
        ...
        var _organizationUnitLookupTableModal = new app.ModalManager({
            ...
            scriptUrl: abp.appPath + 'view-resources/App/Notifications/_OrganizationUnitLookupTableModal.js',
        ...
        $('#CreateMassNotificationModal_TargetNotifiers').change(function () {
            ...
            var isSMSSelected = selectedTargetNotifiers.indexOf("TNT.Mini.Notifications.SmsRealTimeNotifier") >= 0;
