(function () {
  app.modals.AddRoleModal = function () {
    ...
    function updateSaveButtonState() {
      ...
      var selectedShift = _$table.find('input[name="selectedRole"]:checked');
    ...
    this.init = function (modalManager) {
        ...
        columnDefs: [
          {
            ...
            render: function (data) {
              return (
                ...
                '<input type="radio" name="selectedRole" id="radio_' +
                data.id +
      ...
      _$table.on('change', 'input[name="selectedRole"]', function () {
        updateSaveButtonState();
      });
      _modalManager
        .getModal()
      ...
      _modalManager
        ...
        .click(function () {
          ...
          var selectedRow = dataTable.row($('input[name="selectedRole"]:checked').closest('tr')).data();
          var roleNameDisplay = selectedRow.name;
          var roleId = selectedRow.value;
