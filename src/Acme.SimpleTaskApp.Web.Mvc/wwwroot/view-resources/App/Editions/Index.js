(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      ...
      scriptUrl: abp.appPath + 'view-resources/App/Editions/_CreateModal.js',
      modalClass: 'CreateEditionModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'App/Editions/EditModal',
      scriptUrl: abp.appPath + 'view-resources/App/Editions/_EditModal.js',
    ...
    var _moveTenantsToAnotherEditionModal = new app.ModalManager({
      ...
      scriptUrl: abp.appPath + 'view-resources/App/_MoveTenantsToAnotherEditionModal.js',
