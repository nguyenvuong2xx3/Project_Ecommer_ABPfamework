...
(function (global, $) {
    ...
    <form class="form-generat-meme mt-5" action="meme-generator-callback" method="post" enctype="multipart/form-data">
    <a href="#" type="submit" class="generate_meme btn btn-default btn-primary form-submit " id="GenerateImage" disabled="disabled" >`+ canvas_info.i18n.imageGeneratorText + `</a>
        ...
        $(this).each(function (delta) {
            ...
            var canvas_info = {
                ...
                i18n: {
                    ...
                    mergeImageText: 'Thêm hình ảnh',
                    drawText: 'Draw',
                    addTextBoxText: 'Add TextBox',
                    previewText: 'Preview',
                    addTemplateText: 'Add template',
                    resetText: 'Reset',
                    imageGeneratorText: 'Tải xuống hình ảnh',
            ...
            MemeGeneratorAPI.popupMoreOption = function (text_info) {
                ...
                container.find(".wrapperRenderPopupMoreOptions").css({
                    left: position.left + parseFloat(marginLeft) + text_info.elementChanged.outerWidth() - $(".wrapperRenderPopupMoreOptions").outerWidth() + "px",
                    "z-index": MemeGenerator.find_highest_ZIndex()
                }).show();
            };
