  ...
  $(function () {
        ...
        },
        {
          ...
          render: function (displayName, type, row, meta) {
            ...
            if (row.isStatic) {
              $span.append(
                $('<span/>')
                  .addClass('badge bg-black text-white')
            ...
            if (row.isDefault) {
              $span.append(
                $('<span/>')
                  .addClass('badge bg-primary text-white')
                  .attr('data-bs-toggle', 'tooltip')
    ...
    function deleteRole(role) {
      abp.message.confirm(
        ...
        { confirmButtonText: app.localize('Delete'), confirmButtonColor: '#dc3545', cancelButtonText: app.localize('Cancel') }
      );
    }
    ...
    $('#GetRolesButton').click(function (e) {
      e.preventDefault();
      getRoles();
    });

    $('#RolesTableFilter').on('keydown', function (e) {
      if (e.keyCode !== 13) {
        return;
      }
