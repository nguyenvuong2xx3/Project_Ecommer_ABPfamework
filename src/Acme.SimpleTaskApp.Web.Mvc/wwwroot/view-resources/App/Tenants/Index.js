(function () {
  $(function () {
    ...
    var _entityTypeFullName = 'BBK.SaaS.MultiTenancy.Tenant';
    ...
    var _createModal = new app.ModalManager({
      ...
      scriptUrl: abp.appPath + 'view-resources/App/Tenants/_CreateModal.js',
      modalClass: 'CreateTenantModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'App/Tenants/EditModal',
      scriptUrl: abp.appPath + 'view-resources/App/Tenants/_EditModal.js',
      modalClass: 'EditTenantModal',
    });

    var _featuresModal = new app.ModalManager({
      viewUrl: abp.appPath + 'App/Tenants/FeaturesModal',
      scriptUrl: abp.appPath + 'view-resources/App/Tenants/_FeaturesModal.js',
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (isActive) {
            if (isActive) {
              return '<span class="badge bg-success text-white">' + app.localize('Yes') + '</span>';
            } else {
              return '<span class="badge bg-dark text-white">' + app.localize('No') + '</span>';
            }
          },
        },
        {
