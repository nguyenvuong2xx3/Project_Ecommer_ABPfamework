  ...
  app.ModalManager = (function () {
    ...
    return function (options) {
      ...
      function _setBusy(isBusy) {
        ...
        var $buttons = _$modal.find('.modal-footer button, .modal-header button.close');
        if ($.fn.buttonBusy) {
          $buttons.buttonBusy(isBusy);
        } else {
          // Fallback implementation if buttonBusy plugin is not available
